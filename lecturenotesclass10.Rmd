...
- What is the probability a randomly selected patient received the placebo
  and the treatment?
  This is known as a disjoint probability, where there are two things that are not possible at the same time. This probability is 0%
...
```{r summarize_rolls}
roll_results %>% 
  smmarise(event_1_prob = mean(event_1),
